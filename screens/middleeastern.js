    ...
    return (
      <div>
        ...
        <div style={{ width: '100%', height: '800px', backgroundColor: '#E1DEDE' }}>
          ...
          <div style={{ margin: '20px 0', height: '40px', display: 'flex', overflowX: 'scroll' }}>
            <Link to="/western" style={{ width: '160px', marginRight: '10px' }}>
              <button>Italian</button>
            </Link>
            <Link to="/french" style={{ width: '160px', marginRight: '10px' }}>
